...
def categorize_item_inputs(
    ...
    required_inputs, default_inputs = HubDeployService.categorize_item_inputs(
        item_info=item_info,
...
def check_missing_required_inputs(
    ...
    return HubDeployService.check_missing_required_inputs(
...
def validate_item_input_types(
    ...
    return HubDeployService.validate_item_input_types(
        parsed_inputs=parsed_inputs,
        item_info_inputs=item_info_inputs,
    )
